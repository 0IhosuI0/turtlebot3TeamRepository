...
class QRCodeFollower(Node):
    def __init__(self):
        ...
        self.critical_safety_distance = 0.3  # For very close obstacles, move backward
    ...
    def scan_callback(self, msg):
        # LiDAR data processing for better obstacle detection
    ...
    def image_callback(self, msg):
        ...
        # --- Obstacle Avoidance & Motion Command ---
    ...
    def generate_motion_command(self, target_box, frame_width):
        ...
        # 3. Side Obstacle Avoidance Layer
    ...
    def get_following_twist(self, target_box, frame_width):
        ...
        twist_msg.angular.z = -0.003 * error_x  # 회전 각도를 적절히 조정하여 타겟을 화면에 맞추기
